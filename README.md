...
Repositório do grupo de estudos do [Training Center](https://training-center.github.io) sobre tecnologias Front-end.
...
Este grupo se destina ao estudo de tecnologias Front-end.
...
Basta responder [este formulário]() para sabermos seu nível de conhecimento, entrar no [Slack do Training Center](https://github.com/training-center/slack) e entrar no canal **#frontend-studies**.
...
Caso você precise entrar em contato com as pessoas responsáveis por este grupo de estudos, pode chamar por `@leonantvrs` no Slack do Training Center.
